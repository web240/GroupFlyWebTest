...
namespace GroupflyGroup.ECommerce.ObjectFramework
{
    ...
    /// </summary>
    [Serializable]
    public class EcProductSpecificationValue : RelationshipObjekt
    {
        /// <summary>
        ///     规格
        /// </summary>
        public EcProductSpecification Source
        {
            get { return GetProperty<EcProductSpecification>(PropertyNames.source); }
