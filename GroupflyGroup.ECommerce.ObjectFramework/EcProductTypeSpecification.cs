...
namespace GroupflyGroup.ECommerce.ObjectFramework
{
    ...
    /// </summary>
    [Serializable]
    public class EcProductTypeSpecification : RelationshipObjekt
    {
        /// <summary>
        ///     商品类型
        /// </summary>
        ...
        ///     规格
        /// </summary>
        public EcProductSpecification Related
        {
            get { return GetProperty<EcProductSpecification>(PropertyNames.related); }
