...
class BpmnView extends UIComponentBase {
    ...
    static elementName = "Gf-BpmnView".toLowerCase();

    /**Bpmn建模器容器*/    
    private _bpmnViewContainer: HTMLDivElement;

    /**Bpmn建模器方法*/
    private _bpmnView: any;
    ...
    /** bpmn视图北部区域*/
    private _bpmnViewNorth: HTMLDivElement;

    /** bpmn视图中心内容区域*/
    private _bpmnViewCenter: HTMLDivElement;

    /**布局*/
    private _bpmnViewLayout: HTMLDivElement;
    ...
    *Bpmn视图元素点击事件
    */
    protected BpmnModelerElementClick(event) {
