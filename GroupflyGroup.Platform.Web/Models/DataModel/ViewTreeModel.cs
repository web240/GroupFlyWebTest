...
namespace GroupflyGroup.Platform.Web.Models
{
    ...
    public class ViewTreeModel : TreeModel
    {
        ...
        /// </summary>
        /// <param name="id"></param>
        public ViewTreeModel(string id) : base(id)
        {
        ...
        /// 子元素
        /// </summary>
        public List<ViewTreeModel> children { get; set; } = new List<ViewTreeModel>();
        ...
        public void GetChildrenViews()
        {
            ...
            if (this.viewType == "ObjektDetailView" || this.viewType == "ObjektCustomFormView")
            {
                ...
                foreach (Match match in matches)
                {
                    ...
                    var model = new ViewTreeModel(viewid);
            ...
            if (this.isDirectory)
            {
                ...
                if (id.IndexOf("@Property") > -1)
                {
                    if (this.isDirectory)
                    {
                        ...
                        {
                            var model = new ViewTreeModel(son.Id);
                        ...
                        if (objektviews.Count > 0)
                        {
                            ...
                            var objektview = new ViewTreeModel("ObjektCustomFormView@Klass");
                ...
                else
                {
                    if (id.IndexOf("ObjektCustomFormView") > -1)
                    {
                        ...
                        foreach (var view in objektviews)
                        {
                            ...
                            var model = new ViewTreeModel(view.Id);
                            model.parentId = parentId;
